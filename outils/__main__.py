...
def main(argv: Sequence[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Everyday tools in the terminal: a calendar, clocks, the weather forecast, this computer's public IP, the Game of Life or snake.")
